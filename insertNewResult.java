...
public class insertNewResult extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Basic Electrical Eng.");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String physicsI = jTextField2.getText();
        String chemistryI = jTextField3.getText();
        String mathsI = jTextField4.getText();
        String mechanics = jTextField5.getText();
        String bee = jTextField6.getText();
        ...
        try
        {
            ...
            if(rs.next()){
                st.executeUpdate("insert into result (rollno,physicsI,chemistryI,mathsI,mechanics,bee) values ('"+rollno+"','"+physicsI+"','"+chemistryI+"','"+mathsI+"','"+mechanics+"','"+bee+"')");
        ...
        {
//            System.out.print(e);  // Debug Purpose
