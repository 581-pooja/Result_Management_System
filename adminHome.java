...
public class adminHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CSE", "ME", "IT", "EXTC" }));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            ...
            setVisible(false);   // Login page will not visible
            new adminHome().setVisible(true);    // adminHome is Visible
        ...
        catch(Exception e)
        {
            ...
            setVisible(false);  // Login page will not visible
            new adminHome().setVisible(true);   // login page will be visible
//            System.out.print(e);
        }
